...
- **`foundation/templates/season_output_template.md`** and **`foundation/templates/offseason_output_template.md`** — the two confirmed, user-authored output formats for every in-season and offseason turn.
