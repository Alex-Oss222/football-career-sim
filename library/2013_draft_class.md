...
This is a **historical pre-draft information library**, not a list of true talent values.

- A board rank records one evaluator's view at a dated point in the process. It is evidence about contemporary perception, not objective truth.
- Disagreement is preserved. Do not average competing boards into a fake exact consensus grade.
- Measurables are combine or explicitly labeled pro-day/workout results available before the draft. DNP means the player did not perform that drill at the combine.
...
- **MAYOCK-POS** — Mike Mayock, final position rankings, NFL.com, 2013-04-18.
- **MAYOCK-100** — Mike Mayock, Top 100 prospects, NFL.com, 2013-04-19.
- **BRANDT-125** — Gil Brandt, final Hot 100 + 25, NFL.com, 2013-04-24.
- **SI-OFF / SI-DEF** — Sports Illustrated position rankings, 2013-03-26.
- **NORRIS-[POS]** — Josh Norris' April 2013 NFL.com position-series evaluations.
- **MCGINN-[POS]** — Bob McGinn / Milwaukee Journal Sentinel position series, 2013-04-18 through 2013-04-24, based heavily on contemporaneous NFL personnel interviews.
- **PFW-[POS]** — Patriots Football Weekly prospect notes published by Patriots.com immediately before the draft.
- **COMBINE-[POS]** — Steelers Depot's live 2013 combine measurement/result tables, cross-checked on major prospects against contemporaneous NFL.com combine reporting.
- **PRODAY** — named NFL.com contemporaneous pro-day/workout reports.
- **SPECIALISTS** — April 2013 specialist rankings from WalterFootball, cross-checked against the Milwaukee Journal Sentinel specialist survey and Raiders.com's pre-draft specialist overview.

## 2. What the class looked like before anyone was selected

The useful historical picture is not "weak class" or "strong class" as a single label. Contemporary evaluators saw an unusual distribution of strength.

1. **The top of the class was trench-heavy.** Mayock's final overall top 11 contained three offensive tackles (Eric Fisher, Luke Joeckel, Lane Johnson), two guards (Chance Warmack, Jonathan Cooper), three defensive front-seven edge players (Dion Jordan, Ezekiel Ansah, Barkevious Mingo), and three interior defensive linemen (Sharrif Floyd, Sheldon Richardson, Star Lotulelei). [MAYOCK-100]
2. **There was no settled elite quarterback.** Geno Smith was the most common QB1 on major late boards, but the ordering behind him varied widely and even Smith was not universally QB1. Josh Norris ranked Tyler Wilson first at the position; Mayock finished Smith first, EJ Manuel second, Matt Barkley third, Ryan Nassib fourth, and tied Tyler Bray/Mike Glennon fifth. [MAYOCK-POS] [NORRIS-QB]
3. **Offensive tackle had the cleanest top-end agreement, but not a unanimous OT1.** Joeckel and Fisher were both treated as top-of-board players. Mayock ultimately put Fisher first overall; Brandt put Joeckel first overall and Fisher fifth. Lane Johnson was the consensus third member of the top tackle tier and was viewed as the premier athlete of the three. [MAYOCK-100] [BRANDT-125] [MCGINN-OL]
4. **Interior offensive line was unusually prominent.** Warmack and Cooper were not merely good guards; both sat in the top eight of Mayock's entire board. Their contrast was central to the discussion: Warmack as the more power-oriented finisher, Cooper as the more mobile space player. [MAYOCK-100] [MCGINN-OL]
5. **The defensive front had depth and role diversity.** Floyd, Richardson and Lotulelei offered different interior profiles, while Jordan, Ansah, Mingo, Werner, Carradine, Datone Jones and others created real scheme-dependent ordering on the edge. [MAYOCK-POS] [SI-DEF] [NORRIS-DL]
6. **Wide receiver offered several different archetypes without one universal WR1.** Tavon Austin's explosive multi-alignment value pushed him to Mayock's WR1 and No. 12 overall by the final week. Cordarrelle Patterson carried rare open-field traits but a much less developed route profile. DeAndre Hopkins, Keenan Allen, Robert Woods and Justin Hunter appealed for very different reasons. [MAYOCK-POS] [MAYOCK-100] [NORRIS-WR] [MCGINN-WR]
7. **Cornerback was deep and the top changed late.** Dee Milliner had been the near-consensus top corner for much of the process. Mayock moved D.J. Hayden to CB1 on April 18 after Hayden's medical return and workout, while other major evaluators still had Milliner or Xavier Rhodes higher. That disagreement is part of the class, not noise to erase. [MAYOCK-POS] [BRANDT-125] [MCGINN-DB]
8. **Running back lacked a universally dominant top prospect.** Eddie Lacy was the most common RB1, but Giovani Bernard, Montee Ball, Andre Ellington, Le'Veon Bell and Christine Michael produced very different role projections. [MAYOCK-POS] [NORRIS-RB]
9. **Tight end had a clear top name but disagreement behind him.** Tyler Eifert was broadly TE1. Ertz, Kelce, Escobar and McDonald changed order depending on how an evaluator valued inline blocking, movement skill and receiving projection. [MAYOCK-POS] [NORRIS-TE]

### Cross-board snapshot of the most prominent prospects

M100 = Mayock overall rank, April 19. B125 = Brandt overall rank, April 24.

| Prospect | Pos | School | M100 | B125 | What the disagreement meant before the draft |
|---|---|---|---:|---:|---|
| Eric Fisher | OT | Central Michigan | 1 | 5 | Mayock preferred Fisher's movement/ceiling; Brandt kept Joeckel ahead. |
| Sharrif Floyd | DT | Florida | 2 | 4 | Broad agreement that he was a premier penetrating interior defender. |
| Luke Joeckel | OT | Texas A&M | 3 | 1 | High-floor technician versus Fisher's slightly greater athletic upside was the common debate. |
| Chance Warmack | OG | Alabama | 4 | 11 | Mayock valued him like a premium overall prospect despite positional value questions around guards. |
| Dion Jordan | DE/OLB | Oregon | 5 | 3 | Length, movement and coverage versatility drove a very high projection despite lighter edge-rush production. |
| Lane Johnson | OT | Oklahoma | 6 | 8 | Exceptional athletic testing with less time at offensive line than Joeckel/Fisher. |
| Sheldon Richardson | DT | Missouri | 7 | 13 | Disruptive movement and range versus questions about consistency against power. |
| Jonathan Cooper | OG | North Carolina | 8 | 12 | Rare mobility for an interior lineman and a very clean movement profile. |
| Ezekiel Ansah | DE | BYU | 9 | 2 | One of the class's biggest ceiling-versus-experience evaluations. |
| Barkevious Mingo | DE/OLB | LSU | 10 | 9 | Rare burst and movement traits; production and down-to-down power created debate. |
| Star Lotulelei | DT | Utah | 11 | 14 | Power and two-gap/inside versatility remained highly valued after a combine medical interruption. |
| Tavon Austin | WR | West Virginia | 12 | 17 | Small frame versus rare space value, return value and alignment versatility. |
| Tyler Eifert | TE | Notre Dame | 13 | 16 | Broad TE1 agreement. |
| D.J. Hayden | CB | Houston | 14 | 43 | The clearest late-board divergence: Mayock moved him to CB1 after medical/workout information improved. |
| D.J. Fluker | OT | Alabama | 15 | 15 | Massive length/power profile, with more debate about edge speed and long-term position. |
| Dee Milliner | CB | Alabama | 16 | 6 | Still CB1 for many evaluators even after Hayden's late rise on Mayock's board. |
| Kenny Vaccaro | S | Texas | 17 | 24 | Matchup versatility, especially versus slots/tight ends, drove S1 status on several boards. |
| Eddie Lacy | RB | Alabama | 18 | 25 | Most common RB1, with workout/conditioning uncertainty layered onto strong tape. |
| Jarvis Jones | OLB | Georgia | 19 | 28 | Highly productive edge tape versus testing and medical questions. |
| Xavier Rhodes | CB | Florida State | 20 | 10 | Size/length/press ability made him especially attractive to press-heavy teams. |
| Geno Smith | QB | West Virginia | 21 | 7 | Most common QB1, but much more variance in overall value than the top trench players. |
| Cordarrelle Patterson | WR | Tennessee | 30 | 21 | Exceptional with the ball, much less polished as a route runner. |
| Desmond Trufant | CB | Washington | 35 | 30 | Senior Bowl/combine athleticism reinforced an already strong cover profile. |
| Keenan Allen | WR | California | 37 | 45 | Tape remained highly regarded while knee recovery and a slow April workout complicated the projection. |
| EJ Manuel | QB | Florida State | 41 | 27 | Physical traits, size and movement gave him one of the widest late-process ranges among quarterbacks. |
| DeAndre Hopkins | WR | Clemson | 42 | 42 | Precise, strong-handed and comparatively polished, with less testing flash than Austin/Patterson. |
| Matt Barkley | QB | USC | 43 | 22 | Experience, timing and anticipation versus arm-strength/physical-ceiling questions. |
| Alec Ogletree | LB | Georgia | 44 | 19 | Range and coverage athleticism were obvious; block handling and documented off-field risk affected boards differently. |
| Zach Ertz | TE | Stanford | 46 | 35 | Productive move/receiving tight end, generally behind Eifert but firmly in the next tier. |
| Tank Carradine | DE | Florida State | 56 | 41 | Strong tape and April ACL-recovery workout made medical timeline central to the evaluation. |
| Giovani Bernard | RB | North Carolina | 63 | 109 | A large board split reflecting role/value differences more than lack of production. |

## 3. Quarterbacks

### Consensus shape

There was no Andrew Luck/Robert Griffin-style top quarterback consensus in 2013. Geno Smith was the **most common final QB1** among major national boards used here, but evaluators disagreed sharply about both the ordering and the overall value of the group. Mayock's final order was Smith, EJ Manuel, Matt Barkley, Ryan Nassib, then Tyler Bray/Mike Glennon tied. Josh Norris was a major dissenting voice, ranking Tyler Wilson first, Smith second, Zac Dysert third, Glennon fourth, Nassib fifth, Barkley sixth and Manuel seventh. [MAYOCK-POS] [NORRIS-QB]

| Prospect | School | Combine / pre-draft measurables | Late-board evidence | Contemporary football read |
|---|---|---|---|---|
| Geno Smith | West Virginia | 6'2 3/8", 218; 9 1/4" hands; official 4.59 40 | Mayock QB1 / M100 #21; Brandt #7; McGinn QB1 | Accurate enough to attack outside the numbers, athletic enough to escape, and productive in a spread passing structure. Debate centered on translating Air Raid reads/footwork to a fuller NFL progression game and whether he created enough outside structure. |
| EJ Manuel | Florida State | 6'4 5/8", 237; 10 3/8" hands; official 4.65 40; 34" vertical | Mayock QB2 / M100 #41; Brandt #27; McGinn QB3 | Premium frame and mobility with a strong arm. Evaluators liked the physical package and leadership presence but disagreed sharply about anticipation, consistency, pressure decisions and whether his passing was natural enough for an early starting role. |
| Matt Barkley | USC | 6'2 1/2" range, 227-231 depending source; ~10" hands; DNP combine workout while recovering from shoulder injury | Mayock QB3 / M100 #43; Brandt #22; McGinn QB2 | Experienced rhythm/timing passer with extensive starts, pre-snap experience and anticipation. Main questions were arm strength, ability to extend under pressure and how much of his efficiency depended on timing/structure. |
| Ryan Nassib | Syracuse | 6'2 1/8", 227; 10 1/8" hands; combine live table 4.84, with timing-source variation | Mayock QB4 / M100 #50; Brandt #50 | Decisive and experienced working through reads, with adequate arm talent. Pocket movement could become hurried and evaluators differed on whether the ceiling justified an early investment. |
| Mike Glennon | NC State | 6'7 1/8", 225; 9 5/8" hands; ~5.00 40 in contemporary combine logs | Mayock T-QB5 / M100 #81; Brandt #71 | Height and arm strength created clear vertical-passing appeal. Pressure response, lower-body mechanics and movement inside a collapsing pocket were the recurring concerns. |
| Tyler Bray | Tennessee | 6'6 1/8", 232; 9 1/4" hands; ~5.00 40 | Mayock T-QB5 / M100 #86; Brandt #103 | One of the strongest pure arms in the class. The evaluation depended on whether a staff believed it could stabilize footwork, decision-making and consistency. |
| Tyler Wilson | Arkansas | 6'2 1/8", 215; 8 3/4" hands; ~4.9 40 | Outside Mayock Top 100; Brandt #94; Norris QB1; McGinn upper group | Norris valued his willingness to throw under pressure and from imperfect platforms. Other evaluators were less convinced by size/hand measurements, ball security and whether his aggressive style would translate cleanly. |

**Simulation use:** do not create one secret "QB order." A quarterback-needy club should weigh scheme, required processing structure, movement needs, tolerance for mechanical development and risk. The real 2013 disagreement was substantial.

## 4. Running backs

### Consensus shape

Eddie Lacy was the clearest common RB1, but this was not viewed as a class with one uncontested blue-chip back. Mayock ranked Lacy #18 overall, then Montee Ball #52, Giovani Bernard #63, Andre Ellington #75, Christine Michael #87 and Le'Veon Bell #94. Josh Norris preferred Bernard second and Ellington third, while Mayock had Ball second. [MAYOCK-100] [NORRIS-RB]

| Prospect | School | Combine / workout measurables | Late-board evidence | Contemporary football read |
|---|---|---|---|---|
| Eddie Lacy | Alabama | Combine: 5'11", 231, DNP drills; April 11 workout around 230 with reported 4.57/4.60 40s | Mayock RB1 / #18; Brandt #25; Norris RB1; PFW RB1 | Thick, powerful runner with enough acceleration, balance through contact and receiving utility. The April workout produced conditioning questions and did not erase the strong game tape. |
| Montee Ball | Wisconsin | 5'10 1/2", 214; 4.66 40; 15 bench; 32" vertical | Mayock RB2 / #52; Brandt #48 | Extremely productive, patient and decisive in a structured run game. Questions centered on workload mileage, top-end speed and how much his college environment helped create clean reads. |
...
The order moved significantly during the process. Mayock's pre-combine board had Cordarrelle Patterson first and Tavon Austin fourth. By April 18, Mayock had Austin first, Patterson second, Justin Hunter third, Keenan Allen fourth, and DeAndre Hopkins/Robert Woods tied fifth. Norris had Austin first, Patterson second, Hopkins third, Allen fourth, Quinton Patton fifth, Markus Wheaton sixth, Woods seventh, Stedman Bailey eighth and Hunter ninth. [MAYOCK-POS] [NORRIS-WR]

| Prospect | School | Combine / workout measurables | Late-board evidence | Contemporary football read |
|---|---|---|---|---|
| Tavon Austin | West Virginia | 5'8 1/2", 174; 30" arms; 9 1/8" hands; official 4.34 40; 32" vertical; 4.01 shuttle | Mayock WR1 / #12; Brandt #17; McGinn WR1; Norris WR1 | Rare space player who could align in slot, backfield and return game. Elite acceleration, vision and change of direction drove the grade. The obvious concern was whether a 174-pound player could handle NFL contact and volume. |
| Cordarrelle Patterson | Tennessee | 6'1 7/8", 216; 31 3/4" arms; 9" hands; official 4.42 40; 37" vertical; 10'8" broad | Mayock WR2 / #30; Brandt #21; McGinn WR2; Norris WR2 | Exceptional open-field runner for his size with return/rush value and easy acceleration. The central concern was route development after only one major-college season and a relatively limited route inventory. |
| Justin Hunter | Tennessee | 6'4", 196; 33 1/4" arms; 4.44 40; 39.5" vertical; 11'4" broad | Mayock WR3 / #32; Brandt #33 | Height/speed/explosion combination created classic outside-receiver upside. Hands consistency, play strength and recovery from his prior knee injury were major evaluation points. |
| Keenan Allen | California | 6'2", 206; 32 3/4" arms; 10" hands; DNP combine; April workout 4.71/4.75 while still regaining explosion after PCL injury | Mayock WR4 / #37; Brandt #45; SI WR3; Norris WR4 | Strong route tempo, ball skills and run-after-catch toughness mattered more than pure timed speed to supporters. Knee recovery and the slow April workout created uncertainty about available explosiveness at the time. |
| DeAndre Hopkins | Clemson | 6'1", 214; 33 3/8" arms; 10" hands; 4.57 40; 36" vertical | Mayock T-WR5 / #42; Brandt #42; Norris WR3 | One of the most polished route/catch profiles in the group. Strong hands, competitive catches and route precision offset a merely average timed-speed profile. |
| Robert Woods | USC | 6'0 3/8", 201; 31" arms; 9 1/4" hands; 4.51 40; 33.5" vertical | Mayock T-WR5 / #45; Brandt #34; Norris WR7 | Experienced, technically advanced short/intermediate receiver with slot flexibility. Evaluators questioned whether he offered the same explosive ceiling as Austin/Patterson/Hunter. |
| Quinton Patton | Louisiana Tech | 6'0", 204; 32 7/8" arms; 9 3/8" hands; 4.53 40 | Mayock #78; Brandt #81; Norris WR5 | Smooth route runner with body control and reliable hands. Level-of-competition translation and lack of rare size/speed pushed him below the first group on most boards. |
...
| Jarvis Jones | Georgia | About 6'2 3/8", 245; DNP combine athletic drills; Georgia pro day 4.92 40 and 20 bench | Mayock 4-3 OLB1 / #19; Brandt #28 | One of the class's strongest production résumés as an edge rusher, with timing, bend and finishing instincts that showed more clearly on tape than in testing. A prior neck/spinal-stenosis diagnosis was a material team-medical issue even after doctors cleared him to play, and the slow pro-day testing added a separate athletic-projection question. |
...
- Marcus Lattimore pre-draft recovery/medical discussion, NFL.com, February 18 and April 21, 2013. The April report is especially useful because it preserves contemporaneous scout disagreement rather than a later outcome judgment:  
  https://www.nfl.com/news/marcus-lattimore-progress-will-shock-nfl-doctors-0ap1000000140351  
  https://www.nfl.com/news/marcus-lattimore-s-knee-still-a-concern-to-nfl-scouts-0ap1000000162160
