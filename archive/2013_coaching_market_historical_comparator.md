# Archived Historical Comparator: 2013 NFL Coaching Market

**Archive status:** HINDSIGHT RESEARCH ONLY. Not a runtime hiring-search source.

This file preserves the full real-world 2013 coaching-market research, including actual hires and later staff movement. It is retained for audit and historical fact-checking only. Normal simulation play and the January 2013 hiring search use `library/2013_coaching_market_pre_hire.md` instead.
