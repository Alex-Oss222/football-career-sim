...
7. **All supported player counters are retained.** The machine totals and comprehensive ledger keep passing attempts/yards/interceptions thrown, rushing attempts/yards, receptions/receiving yards, sacks allowed, sacks, pressures, fumbles, field goals made, punts, return yards and tackles whenever the runtime generates them. Cleaner category tables may hide irrelevant zero columns, but the underlying record is not discarded.
