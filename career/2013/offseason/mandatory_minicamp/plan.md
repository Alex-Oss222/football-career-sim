...
If Jacksonville separately conducts the additional voluntary veteran minicamp available to a new-head-coach club, that event follows the voluntary rules in the OTA plan. Do not treat that optional event as this mandatory one.
...
No starter is declared merely because a player had the best scripted practice unless the user/Stone later makes that football decision from the accumulated evidence.
