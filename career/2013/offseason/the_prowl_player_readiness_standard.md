...
Stone's definition of being a professional is broader than knowing the playbook.

A Jaguar is expected to be ready physically, mentally, financially and personally enough that avoidable problems away from the field do not repeatedly become football problems.

The club has responsibilities too.

It cannot demand preparation from players and then refuse to provide the resources that make preparation possible.

The operating phrase remains:

**Good. Better. Best.**

The objective is not perfection.

The objective is becoming harder to knock off course.

# 1. PHYSICAL STANDARD

Stone does not have one body type for the roster.

A 330-pound guard is not expected to move like a corner.

A corner is not judged against a defensive tackle's strength numbers.

A quarterback does not train like a tailback merely because he can run.

Every player's physical standard begins with his football job.

## The Six Team Requirements

Every healthy player is expected to maintain six things.

### 1. Playing Weight

Each player has an individual playing-weight range established by the performance staff.
...
* movement;
* strength;
* previous healthy playing weight;
* body composition;
* football performance;
* injury history;
* conditioning.

Stone does not impose one universal body-fat percentage.

If a 325-pound lineman moves well, maintains strength and can repeatedly execute his assignment, Stone does not make him 305 pounds so the roster looks leaner.

If another player's movement deteriorates at the same weight, his target changes.

The football decides the useful body.

### 2. Functional Strength

Stone wants strength that appears on the field.

The standard includes the ability to:
...
* maintain technique late in a drive.

Weight-room numbers are tracked.

They are not the purpose of the program.

A player does not earn a starting job because he has the best bench press.

A player also cannot repeatedly lose physically and dismiss the strength program as irrelevant.

### 3. Movement

Every position has a movement requirement.
...
* ability to regain speed after changing direction.

Straight-line forty time matters primarily in scouting.

Football movement matters every week.

### 4. Repeated Effort

A player must be capable of performing his normal technique repeatedly.

The first five plays are not enough.

Stone wants to know what happens after eight consecutive snaps, after a long drive, after hurry-up offense, after covering a kick and then returning to scrimmage.

Fatigue is expected.

Technical collapse is what the program is trying to delay.

### 5. Recovery

Recovery is part of the job.

Players are expected to use the resources available to them:
...
* individualized recovery work.

Stone does not treat legitimate injury as a character failure.
...
**Did you arrive physically prepared to begin NFL training camp?**
...
That means strength and conditioning. It means treatment. It means knowing your job.

It also means we're not going to pretend the other twenty hours of your day disappear when you walk through this door.
