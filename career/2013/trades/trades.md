...
## Through the post-draft 2013 roster build

### Jacksonville / Washington — Kirk Cousins

**Timing:** Completed in the pre-draft window before the April 25 draft; the exact execution date and time are not separately fixed in canon.
...
**Timing:** Completed in the same pre-draft personnel window, after the Cousins acquisition and before the April 25 draft; the exact execution date and time are not separately fixed in canon.

| Team | Receives |
|---|---|
| Jacksonville | DE C.J. Wilson |
| Green Bay | QB Blaine Gabbert |

This is a player-for-player trade with no draft selection attached. Jacksonville converts surplus quarterback depth into a veteran defensive-front rotation candidate while retaining Chad Henne as veteran insurance behind the Cousins competition. Wilson receives no promised starting job or package role.

Exact outgoing Gabbert acceleration/savings and Wilson's incoming 2013 contract charge are not invented here; career/2013/offseason/initial_cap_sheet.md carries the unresolved accounting treatment.
