...
| Alex Stone biography | *Resolved 2026-09-17, before career initialization.* Position, playing years, education, spouse name/program, and relocation constraint were resolved by explicit user instruction; the Patriots tenure and the January 2009 employment snapshot were dropped entirely rather than resolved to a version. | User canon choice | Active canon; see Document 3 §1.1-§1.6 | None remaining |
